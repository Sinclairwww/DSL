...
class ConfigLoaderTest(unittest.TestCase):
    ...
    def test_good_value(self):
        ...
        self.assertEqual(
            conf.getConfig().get("pwd"), ".", "Failed to extract default value."
        )
...
class ParserTest(unittest.TestCase):
    ...
    def test_parse_job2(self):
        ...
        parser = Parser(conf, lexer)
        with open("./jobs/example_echo.job", "r", encoding="utf-8") as f:
            p = parser.parseStr(f.read())
            p.print()
    ...
    def test_parse_job3(self):
        ...
        parser = Parser(conf, lexer)
        with open("./jobs/example_weather.job", "r", encoding="utf-8") as f:
            p = parser.parseStr(f.read())
            p.print()
...
class RunpyTest(unittest.TestCase):
    ...
    def test_runpy_maximum_args(self):
        self.assertRaises(RuntimeError, self.runpy.callFunc, "test1", self, 2, 3, 4, 5)
...
class MainTest(unittest.TestCase):
    ...
    def test_main_test(self):
        ...
        sys.stdin = open("./tests/in.txt", "r", encoding="utf-8")
        ...
        with open("./tests/out.txt", encoding="utf-8") as f:
            out = f.read()
        with open("./tests/example_output.txt", encoding="utf-8") as f:
            example_out = f.read()
    ...
    def test_main_test2(self):
        ...
        with open("./tests/out.txt", encoding="utf-8") as f:
            out = f.read()
        with open("./tests/example_output2.txt", encoding="utf-8") as f:
            example_out = f.read()
